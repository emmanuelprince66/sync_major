  ...
  return (
    <div className="min-h-screen w-full  bg-[#2F5034] text-white px-6 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="w-full md:w-[70%] mx-auto">
        ...
        />
        <DecorativeStar size="w-6 h-6" position="top-1/2 right-4 md:right-6" />
        <DecorativeStar size="w-3 h-3" position="bottom-20 right-1/3" />
        <DecorativeStar size="w-5 h-5" position="top-64 left-10" />
